 ...
 */
public class Server {
    private static final String DEFAULT_PORT = "12525";
    private static final String DEFAULT_PASSWORD = "121325";
    ...
    public static void main(String[] args) throws InterruptedException, ParseException {
        ...
        formatter1.printHelp(OPTIONS, options);
        ...
        if (cmd.hasOption(CmdOptions.HELP.getOpt()) || cmd.hasOption(CmdOptions.HELP.getLongOpt())) {
            ...
            int port = Integer.parseInt(cmd.getOptionValue(CmdOptions.PORT.getLongOpt(), DEFAULT_PORT));
            String password = cmd.getOptionValue(CmdOptions.PASSWORD.getLongOpt(), DEFAULT_PASSWORD);
